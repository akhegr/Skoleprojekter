...
namespace WindowsFormsPCStore.ZipCityServiceReference {
    ...
    public interface IZipCityService {
        ...
        WindowsFormsPCStore.ZipCityServiceReference.ZipCity Read(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IZipCityService/Read", ReplyAction="http://tempuri.org/IZipCityService/ReadResponse")]
        System.Threading.Tasks.Task<WindowsFormsPCStore.ZipCityServiceReference.ZipCity> ReadAsync(int id);
        ...
        WindowsFormsPCStore.ZipCityServiceReference.ZipCity ReadByZipCode(string zipCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IZipCityService/ReadByZipCode", ReplyAction="http://tempuri.org/IZipCityService/ReadByZipCodeResponse")]
        System.Threading.Tasks.Task<WindowsFormsPCStore.ZipCityServiceReference.ZipCity> ReadByZipCodeAsync(string zipCode);
        ...
        WindowsFormsPCStore.ZipCityServiceReference.ZipCity[] GetAll();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IZipCityService/GetAll", ReplyAction="http://tempuri.org/IZipCityService/GetAllResponse")]
        System.Threading.Tasks.Task<WindowsFormsPCStore.ZipCityServiceReference.ZipCity[]> GetAllAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IZipCityServiceChannel : WindowsFormsPCStore.ZipCityServiceReference.IZipCityService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ZipCityServiceClient : System.ServiceModel.ClientBase<WindowsFormsPCStore.ZipCityServiceReference.IZipCityService>, WindowsFormsPCStore.ZipCityServiceReference.IZipCityService {
        ...
        public WindowsFormsPCStore.ZipCityServiceReference.ZipCity Read(int id) {
            return base.Channel.Read(id);
        }
        
        public System.Threading.Tasks.Task<WindowsFormsPCStore.ZipCityServiceReference.ZipCity> ReadAsync(int id) {
            return base.Channel.ReadAsync(id);
        }
        
        public WindowsFormsPCStore.ZipCityServiceReference.ZipCity ReadByZipCode(string zipCode) {
            return base.Channel.ReadByZipCode(zipCode);
        }
        
        public System.Threading.Tasks.Task<WindowsFormsPCStore.ZipCityServiceReference.ZipCity> ReadByZipCodeAsync(string zipCode) {
            return base.Channel.ReadByZipCodeAsync(zipCode);
        }
        
        public WindowsFormsPCStore.ZipCityServiceReference.ZipCity[] GetAll() {
            return base.Channel.GetAll();
        }
        
        public System.Threading.Tasks.Task<WindowsFormsPCStore.ZipCityServiceReference.ZipCity[]> GetAllAsync() {
